...
class M2_Migration_Handler {
	 ...
	 */
	const TEMP_OPTION_KEY = '_wpmudev_update_to_m2';
	...
	static public function confirm_inline() {
		...
		<table cellpadding="3" cellspacing="3" width="100%" class="widefat">
			<thead>
			<tr>
				<th colspan="2"><?php _e( 'Membership2 Is Available', 'membership' ); ?></th>
			</tr>
			</thead>
			<tbody>
			<tr class="wdv-update">
				<td>
					...
					<p>
					<?php _e( 'Important: Manual plugin configuration required after update! See details for more information.<br>Please confirm that you are ready to unlock this update', 'membership' ); ?>
					</p>
				</td>
				<td style="vertical-align:middle;text-align:right">
					<a href="#unlock-update" id="wpmudev-unlock-<?php echo self::NEW_PLUGIN_ID; ?>" class="button-secondary"><?php _e( 'I understand, unlock the update now', 'membership' ); ?></a>
				</td>
			</tr>
			<tr class="wdv-changelog">
				<td colspan="2">
					<div class="wdv-view-link">
						<a href="#"><?php _e( 'Details', 'membership' ); ?> <i class="wdvicon-chevron-down"></i></a>
					</div>
					...
					<p>
					<?php _e( 'When you update to the new version we will migrate your Subscription plans and Members to the new data structure automatically.<br>However, the protection rules cannot be migrated. So you have to manually <strong>set up all protection rules again</strong> after the update.', 'membership' ); ?><br />
					...
					<div class="wdv-close-link"><a href="#"><?php _e( 'close', 'membership' ); ?> <i class="wdvicon-chevron-up"></i></a></div>
					</div>
				</td>
			</tr>
			</tbody>
				...
				<div class="dev-content-wrapper">
					...
					<div class="dev-cta-wrap">
						...
						<a href="#unlock-update" id="wpmudev-unlock-<?php echo self::NEW_PLUGIN_ID; ?>" class="wpmu-button"><?php
							_e( 'I understand, unlock the update now', 'membership' );
						?></a>
					</div>
				</div>
