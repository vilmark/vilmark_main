			...
			$factory = Membership_Plugin::factory();
					...
					if (isset($_GET['member_id'])) {
												...
												if ($member->toggle_activation()) {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 7, wp_get_referer())));
												} else {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 8, wp_get_referer())));
												}
										}
										break;
								...
								case 'addlevel-level-complete':
										...
										wp_safe_redirect(esc_url_raw( add_query_arg('msg', 3, wp_get_original_referer())));
										break;
		...
		?>
					<div class='wrap nosubsub'>
						...
						<?php
				            if (isset($_GET['msg'])) {
				                ...
				                $_SERVER['REQUEST_URI'] = esc_url_raw( remove_query_arg(array( 'msg' ), $_SERVER['REQUEST_URI']) );
		            		}
				...
				function handle_options_panel_updates() {
						...
						if ($action == 'updateoptions') {
								...
								wp_safe_redirect(esc_url_raw( add_query_arg('msg', 1, wp_get_referer())));
						} elseif (!empty($action)) {
								...
								wp_safe_redirect(esc_url_raw( add_query_arg('msg', 2, wp_get_referer())));
						}
				}
			...
			$factory = Membership_Plugin::factory();
						switch (addslashes($action)) {
								...
								case 'added': $id = (int) $_POST['level_id'];
										...
										if ($id) {
												...
												if ($level->add()) {
														...
														// redirect
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 1, 'admin.php?page=' . $page)));
												} else {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 4, 'admin.php?page=' . $page)));
												}
										} else {
												wp_safe_redirect(esc_url_raw( add_query_arg('msg', 4, 'admin.php?page=' . $page)));
										}
								...
								case 'updated': $id = (int) $_POST['level_id'];
										...
										if ($id) {
												...
												if ($level->update()) {
														...
														// redirect
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 3, 'admin.php?page=' . $page)));
												} else {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 5, 'admin.php?page=' . $page)));
												}
										} else {
												wp_safe_redirect(esc_url_raw( add_query_arg('msg', 5, 'admin.php?page=' . $page)));
										}
								...
								case 'delete': if (isset($_GET['level_id'])) {
												...
												if ($level->delete($level_id)) {
														...
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 6, wp_get_referer())));
												}
										}
										break;
						...
						switch (addslashes($action)) {
								...
								case 'togglepublic':
										if (isset($_GET['sub_id'])) {
												...
												if ($sub->togglepublic()) {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 9, wp_get_referer())));
												} else {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 5, wp_get_referer())));
												}
										}
										break;
				...
				function handle_communication_updates() {
						...
						switch (addslashes($action)) {
								...
								case 'added': check_admin_referer('add-comm');
										...
										if ($comm->add()) {
												wp_safe_redirect(esc_url_raw( add_query_arg('msg', 8, 'admin.php?page=' . $page)));
										} else {
												wp_safe_redirect(esc_url_raw( add_query_arg('msg', 9, 'admin.php?page=' . $page)));
										}
								...
								case 'updated': $id = (int) $_POST['ID'];
										...
										if ($id) {
												...
												if ($comm->update()) {
														...
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 2, 'admin.php?page=' . $page)));
												}
										} else {
												wp_safe_redirect(esc_url_raw( add_query_arg('msg', 2, 'admin.php?page=' . $page)));
										}
								...
								case 'delete': if (isset($_GET['comm'])) {
												...
												if ($comm->delete()) {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 10, wp_get_referer())));
												} else {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 11, wp_get_referer())));
												}
										}
										break;
				...
				case 'sendme':
					...
					if ( $id ) {
						...
						wp_safe_redirect( esc_url_raw( add_query_arg( 'msg', 12, wp_get_referer() ) ) );
					}
					break;
				...
				case 'deactivate':
								...
								case 'activate':
										if (isset($_GET['comm'])) {
												...
												if ($comm->toggle()) {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 3, wp_get_referer())));
												} else {
														wp_safe_redirect(esc_url_raw( add_query_arg('msg', 4, wp_get_referer())));
												}
										}
										break;
			...
			if ( $gateway ) {
				...
				function handle_coupons_updates() {
								...
								case 'added': $id = (int) $_POST['ID'];
										...
										if (!$id) {
											...
											if ( empty( $errors ) ) {
												...
												$url = esc_url_raw( add_query_arg( 'msg', 2, 'admin.php?page=' . $page ) );

												foreach( $errors as $key => $error ) {
													$errors[ $key ] = str_replace( ' ', '_', $error );
												}

												$url = esc_url_raw( add_query_arg( 'errors', $errors, $url ) );
					...
					wp_safe_redirect( esc_url_raw( add_query_arg( 'msg', $msg, 'admin.php?page=' . $page ) ) );
					break;
				...
				case 'delete':
					if ( isset( $_GET['coupon_id'] ) ) {
						...
						wp_safe_redirect( esc_url_raw( add_query_arg( 'msg', $coupon->delete() ? 5 : 6, wp_get_referer() ) ) );
					}
					break;
